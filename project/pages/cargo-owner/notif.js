  ...
  return (
    <>
      <div className="w-screen h-screen bg-[#EBEFF2] p-20 pt-10">
        ...
        {data.map((item) => (
          <button key={item} className="w-full flex flex-col flex-initial bg-white text-black p-10 rounded-xl space-y-2 border border-gray-400 transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-[1.005] hover:shadow-xl hover:shadow-slate-200 hover:bg-blue-100 duration-300 mb-5">
