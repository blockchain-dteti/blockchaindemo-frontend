...
export default function detail_approve() {
  return (
        ...
        <div className="grid grid-cols-10 gap-3">
          ...
          <div className="col-span-7 pl-28">
            <div className="mb-16 relative">
              <p className="w-max absolute top-0 right-0 text-sm text-black py-1 rounded-lg px-10 bg-[#26E42D]">
                Status DO Approve
              </p>
            </div>
            <Definput label="BL Number" value="KMTCXGG2306603" />
            <Definput label="DO Number" value="XGG2306603" />
            <Definput label="DO Expired Date" value="2023-01-31" />
            <Definput label="Vessel" value="Xin Yang Pu" />
            <Definput label="Voyage Number" value="156S" />
