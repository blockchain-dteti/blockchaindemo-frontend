  ...
  return (
    <div className="w-full relative focus:outline-none border border-[#293165] hover:border-[#71B6F9] rounded-md">
      <div
        ...
        className={`bg-white text-black w-full p-3 flex items-center justify-between rounded ${!props.textValue && "text-gray-400 italic"
          }`}
      >
      ...
      <ul
        className={`bg-white text-black mt-2 overflow-y-auto absolute z-10 shadow-lg shadow-slate-500/20 rounded-md w-full ${open
      ...
      >
        ...
        {props.datas?.map((data, index) => (
          <li
            ...
            ${data.startsWith(inputValue) ? "block" : "hidden"}`}
            onClick={() => {
